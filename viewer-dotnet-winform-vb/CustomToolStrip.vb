...
Public Class CustomToolStrip
    ...
    Public Sub CustomToolStrip()
        InitializeComponent()
        ' In the form constructor do not use any Viewer methods (Open, Print etc.) that perform UI activities.
    End Sub
    Private Sub ChangeToolbarToCustom_Click(sender As Object, e As EventArgs) Handles ChangeToolbarToCustom.Click
    ...
    Private Sub RestoreViewerToolbar_Click(sender As Object, e As EventArgs) Handles RestoreViewerToolbar.Click
